...
public class MeteorSand : Item
{
    private const int ID = 5;
    private const string NAME = "Meteor Sand";
    private const string DESCRIPTION = "Sands from the crimson terrain of an asteroid. \n\nThe potion may temporarily increase attack by 25.";
    private const string STATUS_TEXT = "Strengthened";
    private const string TYPE = "Affliction";
    private const int ACCURACY = 3;
    private const int BUFF_VALUE = 25;
    private const int TURNS_ACTIVE = 1;

    private string buffTarget;

    public MeteorSand() : base(ID, NAME, DESCRIPTION, STATUS_TEXT, TYPE, ACCURACY, BUFF_VALUE, TURNS_ACTIVE)
    {
        this.id = ID;
        this.name = NAME;
